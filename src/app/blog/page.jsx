            ...
            <AnimatedSection key={post.id} delay={index * 100}>
              ...
              >
                <div className="w-full md:w-2/5 h-40 md:h-auto overflow-hidden relative shrink-0 border-b md:border-b-0 md:border-r border-slate-100 dark:border-slate-700">
                  ...
                  <img src={post.coverImg} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-5 md:p-8 w-full md:w-3/5 flex flex-col justify-center">
                  <div className="flex items-center gap-2 md:gap-3 text-[10px] md:text-xs font-bold text-slate-500 mb-2 md:mb-3 uppercase tracking-wider">
                  ...
                  <span className="mt-auto inline-flex items-center gap-2 text-xs md:text-sm font-bold text-blue-600 dark:text-blue-400">
