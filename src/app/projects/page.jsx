...
import { ArrowLeft, ArrowRight, Search, MonitorPlay, FileText, FileSpreadsheet, Presentation, ExternalLink, X } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-900/80 backdrop-blur-sm">
          <div className="bg-white w-full max-w-5xl max-h-[90vh] rounded-[2rem] shadow-2xl flex flex-col overflow-hidden border border-brand-green/20 animate-in fade-in zoom-in duration-300">
            <div className="p-6 border-b border-zinc-100 flex justify-between items-center bg-zinc-50/50">
              ...
              <button onClick={() => setSelectedProject(null)} className="p-3 bg-zinc-100 hover:bg-red-500 hover:text-white rounded-full transition-colors flex-shrink-0">
                <X className="w-5 h-5" />
              </button>
            </div>
